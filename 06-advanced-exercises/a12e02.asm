...
section .data
    pfstr1 : db "Entre com P%d (int) no formato x y z: ", 0
    scstr1 : db "%d %d %d", 0
...
main:
    ...
    ; eax = printf("Entre com P%d (int) no formato x y z: ", 1);
    xor rax, rax
    ...
    ; eax = printf("Entre com P%d (int) no formato x y z: ", 2);
    xor rax, rax
    mov rdi, pfstr1 ; string de controle para printf
    mov esi, 2
    call printf
    ...
    ; xmm0-2 -> x1, y1, z1
    ; xmm3-5 -> x2, y2, z2
    cvtsi2sd xmm0, dword [scfP1] 
    cvtsi2sd xmm1, dword [scfP1+4] 
    cvtsi2sd xmm2, dword [scfP1+8] 
    cvtsi2sd xmm3, dword [scfP2] 
    cvtsi2sd xmm4, dword [scfP2+4] 
    cvtsi2sd xmm5, dword [scfP2+8] 
